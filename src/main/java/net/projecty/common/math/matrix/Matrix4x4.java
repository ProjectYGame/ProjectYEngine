package net.projecty.common.math.matrix;

import net.projecty.common.math.vector.Vec3F;
import net.projecty.common.utils.BufferUtil;

import java.nio.FloatBuffer;

public class Matrix4x4 {
	private static final FloatBuffer IDENTITY = BufferUtil.createFloatBuffer(16);
	...
	private FloatBuffer buffer = BufferUtil.createFloatBuffer(16);
